...
function Home() {
    return (
      <main>
        <section id='days' className='flex flex-col items-center text-center align-middle font-yanone tracking-widest text-3xl font-normal text-green-900 pt-5 gap-3'>
            <div>ENS CASEM!</div>
