        ...
        />
            <div className="font-yanone text-green-800 text-xl font-medium rounded-lg py-4 mx-auto w-full lg:max-w-4xl tracking-widest">
                <div className="flex flex-col space-y-4">
                    ...
                    <div className="space-x-4">
                        <span>· Us deixem el <a className='text-orange-800' href='/Glamping%20Zenith%20Experience.pdf' download>PDF</a> informatiu del tipus d’allotjament que ofereixen.</span>
                    </div>
                    <div className="space-x-4">
                    ...
                    <div className="space-x-4">
                        <span>· També us deixem la llista <a className='text-orange-800' href='/allotjaments.pdf' download>d’allotjaments </a> de la zona per qui busqui una alternativa.</span>
                    </div>
                </div>
            </div>
        </div>
